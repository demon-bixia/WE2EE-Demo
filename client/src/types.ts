import type { InitialMessageKeys, ReceivedKeyBundle, SharedSecret, DHResult, KeyPair } from '$lib/WE2EE/types';
...
export interface ISocketClient {
  ...
  receiveMessage?: (message: ITextMessage | IECDHMessage | IUpdateMessage) => void;
  sendMessage?: (messageContent: string) => void;
  saveMessage?: (message: ITextMessage | IInitialMessage | IECDHMessage, content: string) => void;
  broadcastMessage?: (subject: TMessageTypes, to: string, keys: SharedSecret[] | DHResult[] | (SharedSecret | DHResult)[], IK: KeyPair, save: boolean, content?: string, extraData?: any) => void;
